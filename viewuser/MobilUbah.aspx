<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MobilUbah.aspx.vb" Inherits="carspot.MobilUbah" %>
...
<head runat="server">
    ...
    <title>Ubah Mobil | Car Spot</title>
</head>
<body>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Form Ubah Mobil</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <asp:Image ID="ImgFoto" runat="server" Width="200px" Height="200px" />
                                    </div>
                                </div>
                                <asp:Button ID="BtnSimpan" runat="server" class="btn btn-primary" Text="Simpan" OnClick="BtnSimpan_Click" />
                                <asp:Button ID="BtnKembali" runat="server" class="btn btn-danger" Text="Kembali" OnClick="BtnKembali_Click" />
                            </div>
                        </div>
                    </div>
                </div>
