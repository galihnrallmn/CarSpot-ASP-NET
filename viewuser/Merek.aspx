<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Merek.aspx.vb" Inherits="carspot.Merek" %>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        ...
                        <br/>
                        <a href="MerekTambah.aspx" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:Table ID="TblMerek" runat="server" utoGenerateColumns="True" CssClass="table table-striped" BorderStyle="Solid" BorderWidth="1px" CellPadding="10" CellSpacing="3" GridLines="Both">
                            </asp:Table>
                    </div>
                </div>
            </div>
