<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PenjualanTambah.aspx.vb" Inherits="carspot.PenjualanTambah" %>
...
<head runat="server">
    ...
    <title>Tambah Penjualan | Car Spot</title>
</head>
<body>
...
<main class="main-content">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Form Tambah Penjualan</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
    ...
    <asp:DropDownList ID="DdlMobil" runat="server" class="form-control"></asp:DropDownList>
</div>
                                                        <div class="form-group col-lg-6">
    ...
    <asp:TextBox ID="TxtTglPenjualan" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
</div>
                        </div>
