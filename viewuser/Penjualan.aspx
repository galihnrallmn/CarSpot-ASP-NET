<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Penjualan.aspx.vb" Inherits="carspot.Penjualan" %>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        ...
                        <br/>
                        <a href="PenjualanTambah.aspx" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
                <div class="card-body">
